...
//                     costo = redondeo(costo,2);
                    ...
                    //#style bodys
                   table.set(0, i+1,""+Integer.parseInt(pro.getQty()));     
                   //#style bodys
...
//                    table.setSelectionMode( TableItem.SELECTION_MODE_ROW  );
                 //#style bodys
                   table.set(0, i+1, ""+(int)qty);     
//                   table.setSelectionMode( TableItem.SELECTION_MODE_ROW  );
                 //#style bodys
                   table.set(1, i+1, invitem.getNotes());
...
//            
    ...
    {   
        //#style mailAlert
        Alert error = new Alert(titulo,mensaje , getImageInfo(), AlertType.INFO);
        error.setTimeout(1212313123);
        Display.getDisplay(this).setCurrent(error);
    }
